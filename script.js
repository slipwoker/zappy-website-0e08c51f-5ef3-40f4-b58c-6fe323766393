    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      fetch(contactForm.action || window.location.href, {
        ...
        .catch(function () {
          ...
          successMsg.style.display = 'block';
          successMsg.classList.add('form-error');
        })
        .finally(function () {
          if (submitBtn) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '0e08c51f-5ef3-40f4-b58c-6fe323766393',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '0e08c51f-5ef3-40f4-b58c-6fe323766393';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '0e08c51f-5ef3-40f4-b58c-6fe323766393';
